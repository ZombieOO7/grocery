                                                                    ...
                                                                    <table width="100%" border="0" cellpadding="0" cellspacing="0" style="font-family: 'Source Sans Pro', sans-serif !important; box-sizing: border-box;width: 100%;">
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                ...
                                                                                <p>{{ __('verify_mail.mail_txt_1') }} </p>
                                                                                <p><a href="{{ route('verify',['uuid' => @$user->uuid ])}}">Verify</a>
                                                                                </p>

                                                                                {{-- <p>{{ __('verify_mail.mail_txt_2') }}</p> --}}
                                                                                <p>{{ __('verify_mail.mail_txt_3') }}</p>
                                                                                <p>{{ __('verify_mail.mail_txt_4') }}</p>
                                                                            </td>
                                                                        </tr>
                                                                        </tbody>
                                                                    </table>
