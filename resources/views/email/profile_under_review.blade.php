                                                                    ...
                                                                    <table width="100%" border="0" cellpadding="0" cellspacing="0" style="font-family: 'Source Sans Pro', sans-serif !important; box-sizing: border-box;width: 100%;">
                                                                        ...
                                                                        <tr>
                                                                            <td>
                                                                                ...
                                                                                <p>Your profile is under review by admin, Once your profile verified, You can use following password to login,</p>
                                                                                <p><b>Password :</b> {{ @$emailData['random_password'] }}</p>
                                                                            </td>
                                                                        </tr>
                                                                        </tbody>
                                                                    </table>
