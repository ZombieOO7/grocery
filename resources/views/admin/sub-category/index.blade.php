...
@section('title', __('formname.subcategory.list'))
        ...
        <div class="m-portlet m-portlet--mobile">
            <div class="m-portlet__body">
                <div class="m-form__content">
                    <h5>{{__('formname.subcategory.list')}}</h5>
                </div>
                <hr>
                <div class="m-portlet__head">
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            <select class="form-control" style='margin:0px 0px 0px 12px' name="action" id='action' aria-invalid="false">
                                ...
                                {{-- <option value="{{config('constant.print')}}">{{__('formname.print')}}</option> --}}
                            </select>

                            <a href="javascript:;" class="btn btn-primary submit_btn" id='action_submit'
                                data-url="{{route('subcategory.multi_delete')}}"
                                data-table_name="sub_category_table">{{__('formname.submit')}}</a>
                            
                            <button class="btn btn-info" style='margin:0px 0px 0px 12px' id='clr_filter'
                                data-table_name="sub_category_table">{{__('formname.clear_filter')}}</button>
                        </div>
                    </div>
                ...
                <!--begin: Datatable -->
                <table class="table table-striped- table-bordered table-hover table-checkable for_wdth" id="sub_category_table"
                    data-type="" data-url="{{ route('subcategory.datatable') }}">
                    <thead>
                        <tr>
                            <th class="nosort">
                            ...
                            <th>{{__('formname.subcategory.title')}}</th>
                            <th>{{__('formname.category.title')}}</th>
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th><input type="text" class="form-control form-control-sm tbl-filter-column"
                                placeholder="{{__('formname.subcategory.title')}}"></th>
                            <th><input type="text" class="form-control form-control-sm tbl-filter-column"
                                placeholder="{{__('formname.category.title')}}"></th>
                            <th><input type="text" class="form-control form-control-sm tbl-filter-column"
...
<script src="{{ asset('backend/js/sub-category/index.js') }}" type="text/javascript"></script>
@stop