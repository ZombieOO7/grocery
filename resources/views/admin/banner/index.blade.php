...
@section('title', __('formname.banner.list'))
    ...
    <div class="m-content">
        ...
        <div class="m-portlet m-portlet--mobile">
            <div class="m-portlet__body">
                    ...
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            ...
                            <a href="javascript:;" class="btn btn-primary submit_btn" id='action_submit'
                                data-url="{{route('banner.multi_delete')}}"
                ...
                <!--begin: Datatable -->
                <table class="table table-striped- table-bordered table-hover table-checkable for_wdth" id="banner_table"
                    data-type="" data-url="{{ route('banner.datatable') }}">
                    <thead>
                        <tr>
                            <th class="nosort">
                            ...
                            <th>{{__('formname.banner.image')}}</th>
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th><input type="text" class="form-control form-control-sm tbl-filter-column"
                                placeholder="{{__('formname.banner.image')}}"></th>
                            <th><input type="text" class="form-control form-control-sm tbl-filter-column"
...
<script src="{{ asset('backend/js/banner/index.js') }}" type="text/javascript"></script>
@stop