...
@section('title', __('formname.location.list'))
        ...
        <div class="m-portlet m-portlet--mobile">
            <div class="m-portlet__body">
                <div class="m-form__content">
                    <h5>{{__('formname.location.list')}}</h5>
                </div>
                <hr>
                    ...
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            ...
                            <a href="javascript:;" class="btn btn-primary submit_btn" id='action_submit'
                                data-url="{{route('location.multi_delete')}}"
                                data-table_name="location_table" data-job_url="{{ route('location.multipleJobStatus') }}">{{__('formname.submit')}}</a>
                            <button class="btn btn-info" style='margin:0px 0px 0px 12px' id='clr_filter'
                                data-table_name="location_table">{{__('formname.clear_filter')}}</button>
                        </div>
                    </div>
                ...
                <!--begin: Datatable -->
                <table class="table table-striped- table-bordered table-hover table-checkable for_wdth" id="location_table"
                    data-type="" data-url="{{ route('location.datatable') }}">
                    <thead>
                        <tr>
                            <th class="nosort">
                            ...
                            <th>{{__('formname.location.title')}}</th>
                    ...
                    <tfoot>
                        <tr>
                            ...
                            <th><input type="text" class="form-control form-control-sm tbl-filter-column"
                                    placeholder="{{__('formname.location.title')}}"></th>
                                    <th><input type="text" class="form-control form-control-sm tbl-filter-column"
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
        <div class="modal-content ">
            ...
            <div class="modal-body">
                <h3 class="mdl_ttl">{{ __('formname.location.title') }}</h3>
...
@section('inc_script')
<script>
var url = "{{ route('location.datatable') }}";
/** Show description modal */
...
<script src="{{ asset('backend/js/location/index.js') }}" type="text/javascript"></script>
@stop