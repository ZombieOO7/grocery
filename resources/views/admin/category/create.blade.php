            ...
            <div class="col-lg-12">
                ...
                <div class="m-portlet m-portlet--last m-portlet--head-lg m-portlet--responsive-mobile"
                    ...
                    <div class="m-portlet__body">
                        ...
                        {{ Form::model($category, ['route' => ['category.store', @$category->uuid], 'method' => 'PUT','id'=>'m_form_1','class'=>'m-form m-form--fit m-form--label-align-right','files' => true,'autocomplete' => "off"]) }}
                        @else
                        {{ Form::open(['route' => 'category.store','method'=>'post','class'=>'m-form m-form--fit m-form--label-align-right','id'=>'m_form_1','files' => true,'autocomplete' => "off"]) }}
                        @endif
                            <div class="form-group m-form__group row">
                                {!! Form::label(__('formname.category.title').'*', null,['class'=>'col-form-label
                                col-lg-3
                                col-sm-12']) !!}
                                <div class="col-lg-6 col-md-9 col-sm-12">
                                    {!! Form::text('title',@$category->title,['id'=>'names','class'=>'form-control
                                    m-input err_msg','maxlength'=>config('constant.name_length'),'placeholder'=>__('formname.category.title')]) !!}
                                    @if ($errors->has('title'))
                            ...
                            {{-- <div class="form-group m-form__group row">
                                {!! Form::label(__('formname.category.image'), null,['class'=>'col-form-label
                                col-lg-3 col-sm-12'])
                                !!}
                                <div class="col-lg-6 col-md-9 col-sm-12">
                            ...
                            <div class="form-group m-form__group row" id="imagePreview" style="{{(@$category->image == null)?'none':''}}">
                                <div class="col-md-3 col-sm-12">
                                </div>
                                <div class="col-lg-6 col-md-9 col-sm-12">
                                    @if(@$category->attachment != null)
                                        <a id="new_imagehref0" href="{{@$category->attachment->image_path}}" data-toggle="lightbox">
                                            <img src="{{@$category->attachment->image_path}}" class="imgHeightWidth" id="new_imagehref0" alt="" class="img-fluid">
                                        </a>
                                    @endif
                                </div>
                            </div> --}}
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-lg-6 col-md-9 col-sm-12 img_msg_scn">
                                    ...
                                    @endif
                                    <img id="blah" class="imgHeightWidth" src="{{@$category->attachment->image_path }}" alt="" max-width= "100%";
                                    height= "auto";
                                        style="{{ isset($category->image) ? 'display:block;' : 'display:none;' }}" />
                                </div>
                            </div>
                            <div class="form-group m-form__group row">
...
<script src="{{ asset('backend/js/category/create.js') }}" type="text/javascript"></script>
@stop