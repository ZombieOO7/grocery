...
@section('title', __('formname.category.list'))
        ...
        <div class="m-portlet m-portlet--mobile">
            <div class="m-portlet__body">
                <div class="m-form__content">
                    <h5>{{__('formname.category.list')}}</h5>
                </div>
                <hr>
                    ...
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            ...
                            <a href="javascript:;" class="btn btn-primary submit_btn" id='action_submit'
                                data-url="{{route('category.multi_delete')}}"
                                data-table_name="category_table">{{__('formname.submit')}}</a>
                            
                            <button class="btn btn-info" style='margin:0px 0px 0px 12px' id='clr_filter'
                                data-table_name="category_table">{{__('formname.clear_filter')}}</button>
                        </div>
                    </div>
                ...
                <!--begin: Datatable -->
                <table class="table table-striped- table-bordered table-hover table-checkable for_wdth" id="category_table"
                    data-type="" data-url="{{ route('category.datatable') }}">
                    <thead>
                        <tr>
                            <th class="nosort">
...
<script src="{{ asset('backend/js/category/index.js') }}" type="text/javascript"></script>
@stop