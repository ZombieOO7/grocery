...
class MultipleEmailJob implements ShouldQueue
{
    ...
    public function sendMail($emailData, $subject, $usersData , $file) {
        foreach ($usersData as $userObj) {
            Mail::to($userObj->email)->send((new EmailNotification($emailData, $subject, $userObj , $file)));
        }
    }
}
